...
public interface NotificationTemplate {
    ...
    public static final String INITIAL_GROUP_EXPENSE = "{username1} paid {expense} {currency} for {product}. You have to pay {remainingSum} {currency}.";
    public static final String EXPENSE = "{username1} paid {expense} {currency} for {product}.";
    public static final String INITIAL_COLLECT_EXPENSE = "{username1} wants to buy {product} worth {expense} {currency} for {trip}. You have to pay {remainingSum} {currency}.";
